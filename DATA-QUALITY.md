...
**Branch audited (DQ-002-B1):** `fix/dq-002-b1-dual-nulls` @ `ae9e37f7bf91dd18ef7bbe8fa83da83bc09ddefe` (B1 data commit).
...
2. Confirm B1 four original duals fixed and three residual decorative duals cleared (`other-unusable`).
