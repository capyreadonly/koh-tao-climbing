...
Updated 19 Sep 2026 (Asia/Bangkok). Living backlog for the native iOS app. Highest first.
...
1. **Land the live tip on `main`** — merge [PR #5](https://github.com/capyreadonly/koh-tao-climbing/pull/5) (`improve/claude-design-ux` @ `bd0ae2f`; 1.0.1 archive tip was `b086672`). `main` is still Aug 23 TF 0.1 (1) (~32 commits behind the tip). Then close superseded [#1](https://github.com/capyreadonly/koh-tao-climbing/pull/1), [#2](https://github.com/capyreadonly/koh-tao-climbing/pull/2), and [#3](https://github.com/capyreadonly/koh-tao-climbing/pull/3) (4.3 uniqueness + build 3 — already in the live tip ancestry). Keep growth docs [PR #4](https://github.com/capyreadonly/koh-tao-climbing/pull/4) separate.
